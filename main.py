...
for i in range(len(cartoon_images)-1):
    all_frames += create_transition_frames(cartoon_images[i], cartoon_images[i+1], steps= 8)
    all_frames += create_steady_frames(cartoon_images[i+1], steps=14) 

all_frames += create_transition_frames(cartoon_images[-1], cartoon_images[0], steps= 8)
all_frames += create_steady_frames(cartoon_images[0], steps=14) 
